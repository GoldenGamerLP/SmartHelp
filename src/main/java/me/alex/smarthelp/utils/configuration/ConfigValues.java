...
public enum ConfigValues {
    ...
    MAX_SUGGESTIONS("smarthelp.maxsuggestions", 4),
    SIMILARITY_TRESHHOLD("smarthelp.similaritythreashhold", 4),
    ...
    COMMAND_LISTING("smarthelp.messages.commandListingFormat", "\n <gray>| <gold><bold><font:minecraft:uniform><place></font></bold> <click:suggest_command:<command>><hover:show_text:'<gray>Click here to insert the Command <gold><command></gold> <gray>(<green><percentage><gray>)</gray>'><gradient:#5e4fa2:#f79459:red><command></gradient></click>");
